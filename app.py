...
from pytank.funciones_app import Campbell,G_method,calcuted_pressure,cw,bw
...
""")
    ...
    try:
        file_prod = st.sidebar.file_uploader("Upload you Production file csv")
        file_press = st.sidebar.file_uploader("Upload your Pressure file csv")
